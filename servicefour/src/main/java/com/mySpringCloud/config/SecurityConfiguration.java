package com.mySpringCloud.config;

import com.mySpringCloud.service.LoginService;
...
public class SecurityConfiguration  {
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            List<com.mySpringCloud.entity.User> users = loginService.getUserByUsername(username);
